        ...
        <nav class="navbar sticky-top navbar-light supportiveNavBG  py-1">
            <div class="container-fluid">
                ...
                <div className='show450px'>
                    ...
                    <a class="navbar-brand btn btnStylingSupportiveNav rounded-0" href="/" style={{ fontSize: '14px' }}><i className='me-1 bi bi-facebook'></i> </a>
                    <a class="navbar-brand btn btnStylingSupportiveNav rounded-0" href="/" style={{ fontSize: '14px' }}><i className='me-1 bi bi-instagram'></i></a>
                    <a class="navbar-brand btn btnStylingSupportiveNav rounded-0" href="/" style={{ fontSize: '14px' }}><i className='me-1 bi bi-twitter'></i> </a>
                </div>
